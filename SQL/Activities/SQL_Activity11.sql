...
SELECT a.customer_name, b.salesman_name AS ",FROM customers a  
...
SELECT o.order_no ,o.order_date,o.purchase_amount, 
    a.customer_name, b.salesman_name, b.commission FROM  
    orders o  
    join customers a 
...
SELECT o.order_no ,o.order_date,o.purchase_amount, 
a.customer_name, b.salesman_name, b.commission  
FROM orders o  join customers a 
on o.salesman_id=a.salesman_id 
and o.customer_id =a.customer_id 
LEFT OUTER JOIN salesman b ON a.salesman_id=b.salesman_id WHERE a.grade<300  
ORDER BY a.customer_id;
...
SELECT o.order_no ,o.order_date,o.purchase_amount, 
a.customer_name,a.grade, 
b.salesman_name, b.commission  
FROM orders o  join customers a 
on o.salesman_id=a.salesman_id 
and o.customer_id =a.customer_id 
LEFT OUTER JOIN salesman b ON a.salesman_id=b.salesman_id WHERE a.grade<300  
